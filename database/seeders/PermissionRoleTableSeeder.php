...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $sub_admin_permission_ids = Permission::whereIn('name',['role_edit','role_show', 'role_access', 'profile_access', 'profile_edit' , 'setting_access', 'user_change_password', 'dashboard_widget_access' ,'staff_access' ,'staff_create', 'staff_edit', 'staff_view', 'staff_delete', 'shift_access', 'shift_create',  'shift_edit' ,'shift_delete','shift_status_update','shift_rating', 'sub_admin_detail_access' , 'sub_admin_detail_create', 'sub_admin_detail_edit', 'sub_admin_detail_view', 'sub_admin_detail_delete', 'location_access', 'location_create', 'location_edit' ,'location_delete', 'occupation_access' ,'occupation_create', 'occupation_edit', 'occupation_status_update', 'occupation_delete', 'notification_create', 'message_access', 'message_create', 'message_edit', 'message_view', 'message_delete'])->pluck('id')->toArray();
