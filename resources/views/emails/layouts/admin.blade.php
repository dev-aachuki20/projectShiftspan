...
<body style="margin: 0; color: #0A2540;">
	<div class="mail-template" style="max-width: 100%; margin: 0 auto;">
		<table cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; margin:0 auto;">
			<thead>
				<tr style="height:180px; width:100%; background-size:cover;background-repeat:no-repeat;">
					<th style="text-align: center;"><img style="padding:30px; max-width:200px;" src="{{ getSetting('site_logo') ? getSetting('site_logo') : asset(config('constant.default.logo')) }}" alt="" title="" /></th>
				</tr>
			</thead>
			<tbody>
				<tr>
