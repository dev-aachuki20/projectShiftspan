                        ...
                        @if(isset($shiftData))
                            ...
                            <div class="form-label">
                                ...
                                <div class="right-sidebox d-flex align-items-center justify-content-center">
                                    ...
                                    <img src="{{ file_exists(public_path($shiftData->authorized_signature_url)) ? $shiftData->authorized_signature_url : asset('images/manager-sign.png')}}" alt="Manager Signature" class="img-fluid">
